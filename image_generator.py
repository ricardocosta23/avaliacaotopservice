...
def create_survey_image(survey_data, survey_url):
    ...
    try:
        ...
        try:
            ...
            subtitle_font = ImageFont.truetype("/usr/share/fonts/truetype/liberation/LiberationSans-Bold.ttf", 36)
            text_font = ImageFont.truetype("/usr/share/fonts/truetype/liberation/LiberationSans-Regular.ttf", 32)
        except:
            try:
                # Fallback fonts
